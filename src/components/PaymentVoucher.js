...
export const PaymentVoucher = ({ voucherdata, printValue, printDiv }) => {
  const num = voucherdata.Rate * voucherdata.Hours;
  const word = converter.toWords(num);
  ...
  return (
    <div>
      ...
      <div ref={componentRef} className="Vmain">
          ...
          <tbody>
            <tr>
              ...
              <th rowSpan="2" width="50%">
                ...
                <br />
                Description of services rendered, work executed or good
                supplied, <br />
            ...
            <tr>
              ...
              <th>
                <p className="left height1 divtext">
              ...
              <th className="divtext">
                {voucherdata.Rate * voucherdata.Hours}
              </th>
              <th>00</th>
            </tr>
            <tr>
        ...
        <section>
          ...
          <p className="divtext">
            ගෙවන නිලධාරියාගේ අත්සන සහ දිනය <br /> Signature of Paying Officer
            and Date
          </p>
          <hr />
        </section>
